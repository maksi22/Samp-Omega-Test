...
void CGame::ToggleGrassPlayer(bool toggle)
{
	if (!toggle)
	{
		CMem::PutSingle<BYTE>(0x53C159, 0x90); // call
		CMem::PutSingle<BYTE>(0x53C15A, 0x90);
		CMem::PutSingle<BYTE>(0x53C15B, 0x90);
		CMem::PutSingle<BYTE>(0x53C15C, 0x90);
		CMem::PutSingle<BYTE>(0x53C15D, 0x90);
	}
	else
	{
		CMem::PutSingle<BYTE>(0x53C159, 0xE8); // call
		CMem::PutSingle<BYTE>(0x53C15A, 0x42);
		CMem::PutSingle<BYTE>(0x53C15B, 0x0E);
		CMem::PutSingle<BYTE>(0x53C15C, 0x0A);
		CMem::PutSingle<BYTE>(0x53C15D, 0x00);
	}
}
