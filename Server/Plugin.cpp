...
cell AMX_NATIVE_CALL TogglePlayerGrassProc(AMX* pAmx, cell* pParams)
{
	RakNet::BitStream bitStream;
	bitStream.Write(!!pParams[2]); // toggle

	return Network::PlayerSendRPC(eRPC::TOGGLE_GRASS, pParams[1], &bitStream);
}
...
AMX_NATIVE_INFO PluginNatives[] =
{
	...
	{ "ToggleGrassPlayer", TogglePlayerGrassProc },
